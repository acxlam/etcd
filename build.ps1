...
go build -a -installsuffix cgo -ldflags $GO_LDFLAGS -gcflags "-N -l" -o bin\etcd.exe "$REPO_PATH"
go build -a -installsuffix cgo -ldflags $GO_LDFLAGS -gcflags "-N -l" -o bin\etcdctl.exe "$REPO_PATH\etcdctl"
